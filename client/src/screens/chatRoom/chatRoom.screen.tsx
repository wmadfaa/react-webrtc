...
import { CallEndRounded, FileCopyRounded } from '@material-ui/icons';
...
const ChatRoomScreen: React.FC = () => {
	...
	const [ copyInviteLinkStatus, setCopyInviteLinkStatus ] = React.useState<'success' | 'unSuccess' | 'none'>('none');
	...
	const handleIceConnectionStateChange = async (connectionState: RTCIceConnectionState) => {
			...
			>
				...
				<DialogContent>
					<DialogContentText id="alert-dialog-slide-description">
						send the room id <b>{`(${WebRTC.getRoomId()})`}</b> to start the conversation!
					</DialogContentText>
				</DialogContent>
				<DialogActions>
					<Button color="primary" startIcon={<FileCopyRounded />} onClick={handleCopyInviteLink}>
